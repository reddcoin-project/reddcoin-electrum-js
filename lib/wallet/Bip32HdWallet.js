...
//                                                                                                                      @formatter:on
    ...
    this.getAccount = function (indexOrAddress) {
        ...
        //default value
        if(!indexOrAddress || indexOrAddress === undefined){
            accountIndex = 0;
        }
    ...
    this.send = function (amount, accIndex, requirePw, to, password, monitor) {
        ...
        var sendFrom = accIndex,
            ...
            addresses = this.getAddresses(), signedTransaction, priKeys;
        ...
        return monitor.broadcastTransaction(signedTransaction, 0);

...
//                                                                                                                      @formatter:on
    ...
    this.checkTransaction = function(initialAmount, tipJarEnabled){
        ...
        _.each(accts, function(account, i){
            ...
            if(account.confirmed >= amount){
                ...
                thisAccount.requiresPassword = true;

                //if(tipJarEnabled && )

                usableAccounts.push(thisAccount);
            }
        });
    ...
    this.send = function (amount, to, password, monitor) {
        var account = this.chooseAccountForTransaction(amount),
